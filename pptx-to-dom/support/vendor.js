...
export async function processSingleSlide (zip, sldFileName, index, slideSize) {
  ...
  // =====< Step 3 >=====
  const slideContent = await readXmlFile(zip, sldFileName, true)
...
// 安全取得slide值
const pick = node => {
  const v = parseInt(node) * slideFactor
  // if (v < 2) {
  //   v = slideWidth * v;
  // }
  return v
...
async function processGroupSpNode (node, warpObj, source) {
  ...
  if (xfrmNode !== undefined) {
    const x = pick(xfrmNode['a:off'].attrs.x)
    const y = pick(xfrmNode['a:off'].attrs.y)
    const chx = pick(xfrmNode['a:chOff'].attrs.x)
    const chy = pick(xfrmNode['a:chOff'].attrs.y)
    const cx = pick(xfrmNode['a:ext'].attrs.cx)
    const cy = pick(xfrmNode['a:ext'].attrs.cy)
    const chcx = pick(xfrmNode['a:chExt'].attrs.cx)
    const chcy = pick(xfrmNode['a:chExt'].attrs.cy)
...
async function processSpNode (node, pNode, warpObj, source, sType) {
  ...
  const idx = (getTextByPathList(node, ['p:nvSpPr', 'p:nvPr', 'p:ph', 'attrs', 'idx']) === undefined) ? undefined : getTextByPathList(node, ['p:nvSpPr', 'p:nvPr', 'p:ph', 'attrs', 'idx'])
...
async function genShape (node, pNode, slideLayoutSpNode, slideMasterSpNode, id, name, idx, type, order, warpObj, isUserDrawnBg, sType, source) {
  ...
  if (shapType !== undefined || custShapType !== undefined /* && slideXfrmNode !== undefined */) {
    const off = getTextByPathList(slideXfrmNode, ['a:off', 'attrs']) || { x: 0, y: 0 }
    const x = parseInt(off.x) * slideFactor
    const y = parseInt(off.y) * slideFactor

    const ext = getTextByPathList(slideXfrmNode, ['a:ext', 'attrs']) || { cx: 0, cy: 0 }
    ...
    if (clrFillType === 'GRADIENT_FILL') {
      ...
      if (fillColor.includes('rgb(')) {
        ...
        svgBgImg = await getSvgImagePattern(node, fillColor, shpId, warpObj)
      }
      // fill="url(#imgPtrn)"
  ...
  if (shapType !== undefined && custShapType === undefined) {
    ...
    switch (shapType) {
      ...
      case 'actionButtonBackPrevious':
        var hc = w / 2; var vc = h / 2; var ss = Math.min(w, h)
      ...
      case 'flowChartTerminator':
        var x1; var x2; var y1; var cd2 = 180; var cd4 = 90; var c3d4 = 270
        x1 = w * 3475 / 21600
        x2 = w * 18125 / 21600
        y1 = h * 10800 / 21600
      ...
      case 'flowChartPunchedTape':
        var x1; var x1; var y1; var y2; var cd2 = 180
        x1 = w * 5 / 20
        y1 = h * 2 / 20
        y2 = h * 18 / 20
        var d = 'M' + 0 + ',' + y1 +
      ...
      case 'flowChartOnlineStorage':
        var x1; var y1; var c3d4 = 270; var cd4 = 90
        x1 = w * 1 / 6
        y1 = h * 3 / 6
        var d = 'M' + x1 + ',' + 0 +
          ' L' + w + ',' + 0 +
      ...
      case 'flowChartDisplay':
        var x1; var x2; var y1; var c3d4 = 270; var cd2 = 180
        x1 = w * 1 / 6
        x2 = w * 5 / 6
        y1 = h * 3 / 6
        // path attrs: w = 6; h = 6;
        ...
        break
      case 'flowChartDelay':
        var wd2 = w / 2; var hd2 = h / 2; var cd2 = 180; var c3d4 = 270; var cd4 = 90
        var d = 'M' + 0 + ',' + 0 +
          ' L' + wd2 + ',' + 0 +
      ...
      case 'flowChartOr':
        ...
        if (shapType == 'flowChartOr') {
          ...
          var iDx; var idy; var il; var ir; var it; var ib; var hc = w / 2; var vc = h / 2; var wd2 = w / 2; var hd2 = h / 2
      ...
      case 'snipRoundRect':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var sAdj1_val = 0.33334
        var sAdj2; var sAdj2_val = 0.33334
      ...
      case 'flowChartPreparation':
        ...
        var maxAdj; var a; var shd2; var x1; var x2; var dy1; var y1; var y2; var vc = h / 2; var hd2 = h / 2
        var ss = Math.min(w, h)
      ...
      case 'star4':
        ...
        var hc = w / 2; var vc = h / 2; var wd2 = w / 2; var hd2 = h / 2
      ...
      case 'star6':
        ...
        var hc = w / 2; var vc = h / 2; var wd2 = w / 2; var hd2 = h / 2; var hd4 = h / 4
      ...
      case 'star12':
        ...
        var hc = w / 2; var vc = h / 2; var wd2 = w / 2; var hd2 = h / 2; var hd4 = h / 4; var wd4 = w / 4
        var adj = 37500 * slideFactor
        var maxAdj = 50000 * slideFactor
        var shapAdjst = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])// [0]["attrs"]["fmla"];
        // console.log("star4 node: ", node, "shapAdjst:", shapAdjst)
      ...
      case 'chord':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var sAdj1_val = 45
        var sAdj2; var sAdj2_val = 270
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
            var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
            if (sAdj_name == 'adj1') {
      ...
      case 'halfFrame':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var sAdj1_val = 3.5
        var sAdj2; var sAdj2_val = 3.5
      ...
      case 'blockArc':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var adj1 = 180
        var sAdj2; var adj2 = 0
        var sAdj3; var adj3 = 25000 * slideFactor
        var cnstVal1 = 50000 * slideFactor
        var cnstVal2 = 100000 * slideFactor
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
      ...
      case 'bracePair':
        ...
        var vc = h / 2; var cd = 360; var cd2 = 180; var cd4 = 90; var c3d4 = 270; var a; var x1; var x2; var x3; var x4; var y2; var y3; var y4
        if (adj < 0) a = 0
        else if (adj > cnstVal1) a = cnstVal1
        else a = adj
        var minWH = Math.min(w, h)
      ...
      case 'leftBrace':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var adj1 = 8333 * slideFactor
        var sAdj2; var adj2 = 50000 * slideFactor
        var cnstVal2 = 100000 * slideFactor
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
            var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
        ...
        var vc = h / 2; var cd2 = 180; var cd4 = 90; var c3d4 = 270; var a1; var a2; var q1; var q2; var q3; var y1; var y2; var y3; var y4
        if (adj2 < 0) a2 = 0
      ...
      case 'rightBrace':
        ...
        var vc = h / 2; var cd = 360; var cd2 = 180; var cd4 = 90; var c3d4 = 270; var a1; var a2; var q1; var q2; var q3; var y1; var y2; var y3; var y4
        if (adj2 < 0) a2 = 0
        else if (adj2 > cnstVal2) a2 = cnstVal2
        else a2 = adj2
        var minWH = Math.min(w, h)
      ...
      case 'bracketPair':
        ...
        var r = w; var b = h; var cd2 = 180; var cd4 = 90; var c3d4 = 270; var a; var x1; var x2; var y2
        if (adj < 0) a = 0
        else if (adj > cnstVal1) a = cnstVal1
        else a = adj
      ...
      case 'leftBracket':
        ...
        var r = w; var b = h; var cd2 = 180; var cd4 = 90; var c3d4 = 270; var a; var y1; var y2
        if (adj < 0) a = 0
      ...
      case 'rightBracket':
        ...
        var cd = 360; var cd2 = 180; var cd4 = 90; var c3d4 = 270; var a; var y1; var y2; var y3
        if (adj < 0) a = 0
        else if (adj > maxAdj) a = maxAdj
        else a = adj
        y1 = Math.min(w, h) * a / cnstVal2
      ...
      case 'corner':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var sAdj1_val = 50000 * slideFactor
        var sAdj2; var sAdj2_val = 50000 * slideFactor
        var cnsVal = 100000 * slideFactor
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
            var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
      ...
      case 'gear9':
        txtRotate = 0
        var gearNum = shapType.substr(4); var d
        if (gearNum == '6') {
      ...
      case 'sun':
        ...
        var g0 = cnstVa3 - a1
        var g1 = g0 * (30274 * refr) / (32768 * refr)
        var g2 = g0 * (12540 * refr) / (32768 * refr)
        var g3 = g1 + cnstVa3
        var g4 = g2 + cnstVa3
        var g5 = cnstVa3 - g1
        var g6 = cnstVa3 - g2
        var g7 = g0 * (23170 * refr) / (32768 * refr)
        var g8 = cnstVa3 + g7
        var g9 = cnstVa3 - g7
        var g10 = g5 * 3 / 4
        var g11 = g6 * 3 / 4
        var g12 = g10 + 3662 * refr
        var g13 = g11 + 36620 * refr
        var g14 = g11 + 12500 * refr
        var g15 = cnstVa4 - g10
        var g16 = cnstVa4 - g12
        var g17 = cnstVa4 - g13
        var g18 = cnstVa4 - g14
        var ox1 = w * (18436 * refr) / (21600 * refr)
        var oy1 = h * (3163 * refr) / (21600 * refr)
        var ox2 = w * (3163 * refr) / (21600 * refr)
        var oy2 = h * (18436 * refr) / (21600 * refr)
        var x8 = w * g8 / cnstVa4
        var x9 = w * g9 / cnstVa4
        var x10 = w * g10 / cnstVa4
        var x12 = w * g12 / cnstVa4
        var x13 = w * g13 / cnstVa4
        var x14 = w * g14 / cnstVa4
        var x15 = w * g15 / cnstVa4
        var x16 = w * g16 / cnstVa4
        var x17 = w * g17 / cnstVa4
        var x18 = w * g18 / cnstVa4
        var x19 = w * a1 / cnstVa4
        var wR = w * g0 / cnstVa4
        var hR = h * g0 / cnstVa4
        var y8 = h * g8 / cnstVa4
        var y9 = h * g9 / cnstVa4
        var y10 = h * g10 / cnstVa4
        var y12 = h * g12 / cnstVa4
        var y13 = h * g13 / cnstVa4
        var y14 = h * g14 / cnstVa4
        var y15 = h * g15 / cnstVa4
        var y16 = h * g16 / cnstVa4
        var y17 = h * g17 / cnstVa4
        var y18 = h * g18 / cnstVa4
      ...
      case 'lightningBolt':
        var x1 = w * 5022 / 21600
        var x2 = w * 11050 / 21600
        var x3 = w * 8472 / 21600
        var x4 = w * 8757 / 21600
        var x5 = w * 10012 / 21600
        var x6 = w * 14767 / 21600
        var x7 = w * 12222 / 21600
        var x8 = w * 12860 / 21600
        var x9 = w * 13917 / 21600
        var x10 = w * 7602 / 21600
        var x11 = w * 16577 / 21600
        var y1 = h * 3890 / 21600
        var y2 = h * 6080 / 21600
        var y3 = h * 6797 / 21600
        var y4 = h * 7437 / 21600
        var y5 = h * 12877 / 21600
        var y6 = h * 9705 / 21600
        var y7 = h * 12007 / 21600
        var y8 = h * 13987 / 21600
        var y9 = h * 8382 / 21600
      ...
      case 'cloudCallout':
        ...
        var rX1 = w * 6753 / 43200; var rY1 = h * 9190 / 43200; var rX2 = w * 5333 / 43200; var rY2 = h * 7267 / 43200
        var rX3 = w * 4365 / 43200
        var rY3 = h * 5945 / 43200; var rX4 = w * 4857 / 43200; var rY4 = h * 6595 / 43200; var rY5 = h * 7273 / 43200
        var rX6 = w * 6775 / 43200
        var rY6 = h * 9220 / 43200; var rX7 = w * 5785 / 43200; var rY7 = h * 7867 / 43200; var rX8 = w * 6752 / 43200
        var rY8 = h * 9215 / 43200
        var rX9 = w * 7720 / 43200; var rY9 = h * 10543 / 43200; var rX10 = w * 4360 / 43200; var rY10 = h * 5918 / 43200
        var rX11 = w * 4345 / 43200
        var sA1 = -11429249 / 60000; var wA1 = 7426832 / 60000; var sA2 = -8646143 / 60000; var wA2 = 5396714 / 60000
        var sA3 = -8748475 / 60000
        var wA3 = 5983381 / 60000; var sA4 = -7859164 / 60000; var wA4 = 7034504 / 60000; var sA5 = -4722533 / 60000
        var wA5 = 6541615 / 60000
        var sA6 = -2776035 / 60000; var wA6 = 7816140 / 60000; var sA7 = 37501 / 60000; var wA7 = 6842000 / 60000
        var sA8 = 1347096 / 60000
        var wA8 = 6910353 / 60000; var sA9 = 3974558 / 60000; var wA9 = 4542661 / 60000; var sA10 = -16496525 / 60000
        var wA10 = 8804134 / 60000
        var sA11 = -14809710 / 60000; var wA11 = 9151131 / 60000
        ...
        if (shapType == 'cloudCallout') {
          var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
          var refr = slideFactor
          var sAdj1; var adj1 = -20833 * refr
          var sAdj2; var adj2 = 62500 * refr
          if (shapAdjst_ary !== undefined) {
            for (var i = 0; i < shapAdjst_ary.length; i++) {
              var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
              if (sAdj_name == 'adj1') {
      ...
      case 'horizontalScroll':
        ...
        var cnstVal2 = 100000 * refr
        var ss = Math.min(w, h)
        var t = 0; var l = 0; var b = h; var r = w
        var a, ch, ch2, ch4
        a = (adj < 0) ? 0 : (adj > cnstVal1) ? cnstVal1 : adj
        ch = ss * a / cnstVal2
        ch2 = ch / 2
      ...
      case 'wedgeEllipseCallout':
        ...
        var ss = Math.min(w, h)
        var dxPos; var dyPos; var xPos; var yPos; var sdx; var sdy; var pang; var stAng; var enAng; var dx1; var dy1; var x1; var y1; var dx2; var dy2
        var x2; var y2; var stAng1; var enAng1; var swAng1; var swAng2; var swAng
        var vc = h / 2; var hc = w / 2
      ...
      case 'wedgeRectCallout':
        ...
        var d_val
        var cnstVal1 = 100000 * slideFactor
        var dxPos; var dyPos; var xPos; var yPos; var dx; var dy; var dq; var ady; var adq; var dz; var xg1; var xg2; var x1; var x2
        var yg1; var yg2; var y1; var y2; var t1; var xl; var t2; var xt; var t3; var xr; var t4; var xb; var t5; var yl; var t6; var yt; var t7; var yr; var t8; var yb
        var vc = h / 2; var hc = w / 2
        dxPos = w * adj1 / cnstVal1
        dyPos = h * adj2 / cnstVal1
        xPos = hc + dxPos
      ...
      case 'wedgeRoundRectCallout':
        ...
        var cnstVal1 = 100000 * slideFactor
        var ss = Math.min(w, h)
        var dxPos; var dyPos; var xPos; var yPos; var dq; var ady; var adq; var dz; var xg1; var xg2; var x1; var x2; var yg1; var yg2; var y1; var y2
        var t1; var xl; var t2; var xt; var t3; var xr; var t4; var xb; var t5; var yl; var t6; var yt; var t7; var yr; var t8; var yb; var u1; var u2; var v2
        var vc = h / 2; var hc = w / 2
        dxPos = w * adj1 / cnstVal1
        dyPos = h * adj2 / cnstVal1
        xPos = hc + dxPos
      ...
      case 'callout3':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var refr = slideFactor
        var sAdj1; var adj1 = 18750 * refr
        var sAdj2; var adj2 = -8333 * refr
        var sAdj3; var adj3 = 18750 * refr
        var sAdj4; var adj4 = -16667 * refr
        var sAdj5; var adj5 = 100000 * refr
        var sAdj6; var adj6 = -16667 * refr
        var sAdj7; var adj7 = 112963 * refr
        var sAdj8; var adj8 = -8333 * refr
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
            var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
            if (sAdj_name == 'adj1') {
      ...
      case 'leftRightRibbon':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var refr = slideFactor
        var sAdj1; var adj1 = 50000 * refr
        var sAdj2; var adj2 = 50000 * refr
        var sAdj3; var adj3 = 16667 * refr
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
            var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
        ...
        var ss = Math.min(w, h)
        var a3; var maxAdj1; var a1; var w1; var maxAdj2; var a2; var x1; var x4; var dy1; var dy2; var ly1; var ry4; var ly2; var ry3; var ly4; var ry1
        var ly3; var ry2; var hR; var x2; var x3; var y1; var y2; var wd32 = w / 32; var vc = h / 2; var hc = w / 2
      ...
      case 'ribbon2':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var adj1 = 16667 * slideFactor
        var sAdj2; var adj2 = 50000 * slideFactor
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
            var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
        ...
        var hc = w / 2; var t = 0; var l = 0; var b = h; var r = w; var wd8 = w / 8; var wd32 = w / 32
      ...
      case 'wave':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var adj1 = (shapType == 'doubleWave') ? 6250 * slideFactor : 12500 * slideFactor
        var sAdj2; var adj2 = 0
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
            var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
      ...
      case 'ellipseRibbon2':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var adj1 = 25000 * slideFactor
        var sAdj2; var adj2 = 50000 * slideFactor
        var sAdj3; var adj3 = 12500 * slideFactor
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
            var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
            if (sAdj_name == 'adj1') {
        ...
        var cnstVal4 = 100000 * slideFactor
        var cnstVal5 = 200000 * slideFactor
        var hc = w / 2; var t = 0; var l = 0; var b = h; var r = w; var wd8 = w / 8
      ...
      case 'rightArrow':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var sAdj1_val = 0.25// 0.5;
        var sAdj2; var sAdj2_val = 0.5
      ...
      case 'leftRightArrow':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var sAdj1_val = 0.25
        var sAdj2; var sAdj2_val = 0.25
        var max_sAdj2_const = w / h
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
            var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
      ...
      case 'quadArrow':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var adj1 = 22500 * slideFactor
        var sAdj2; var adj2 = 22500 * slideFactor
        var sAdj3; var adj3 = 22500 * slideFactor
        var cnstVal1 = 50000 * slideFactor
        var cnstVal2 = 100000 * slideFactor
        ...
        var vc = h / 2; var hc = w / 2; var a1; var a2; var a3; var q1; var x1; var x2; var dx2; var x3; var dx3; var x4; var x5; var x6; var y2; var y3; var y4; var y5; var y6; var maxAdj1
        var maxAdj3
        var minWH = Math.min(w, h)
        if (adj2 < 0) a2 = 0
      ...
      case 'leftRightUpArrow':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var adj1 = 25000 * slideFactor
        var sAdj2; var adj2 = 25000 * slideFactor
        var sAdj3; var adj3 = 25000 * slideFactor
        var cnstVal1 = 50000 * slideFactor
        var cnstVal2 = 100000 * slideFactor
        var cnstVal3 = 200000 * slideFactor
        ...
        var vc = h / 2; var hc = w / 2; var a1; var a2; var a3; var q1; var x1; var x2; var dx2; var x3; var dx3; var x4; var x5; var x6; var y2; var dy2; var y3; var y4; var y5; var maxAdj1
        var maxAdj3
        var minWH = Math.min(w, h)
        if (adj2 < 0) a2 = 0
        else if (adj2 > cnstVal1) a2 = cnstVal1
      ...
      case 'leftUpArrow':
        ...
        var vc = h / 2; var hc = w / 2; var a1; var a2; var a3; var x1; var x2; var dx4; var dx3; var x3; var x4; var x5; var y2; var y3; var y4; var y5; var maxAdj1; var maxAdj3
        var minWH = Math.min(w, h)
        if (adj2 < 0) a2 = 0
        else if (adj2 > cnstVal1) a2 = cnstVal1
        else a2 = adj2
      ...
      case 'bentUpArrow':
        ...
        var vc = h / 2; var hc = w / 2; var a1; var a2; var a3; var dx1; var x1; var dx2; var x2; var dx3; var x3; var x4; var y1; var y2; var dy2
        var minWH = Math.min(w, h)
        if (adj1 < 0) a1 = 0
        else if (adj1 > cnstVal1) a1 = cnstVal1
        else a1 = adj1
      ...
      case 'bentArrow':
        ...
        var sAdj2; var adj2 = 25000 * slideFactor
        var sAdj3; var adj3 = 25000 * slideFactor
        var sAdj4; var adj4 = 43750 * slideFactor
        var cnstVal1 = 50000 * slideFactor
        var cnstVal2 = 100000 * slideFactor
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
        ...
        var th; var aw2; var th2; var dh2; var ah; var bw; var bh; var bs; var bd; var bd3; var bd2
        var th = minWH * a1 / cnstVal2
      ...
      case 'uturnArrow':
        ...
        var sAdj3; var adj3 = 25000 * slideFactor
        var sAdj4; var adj4 = 43750 * slideFactor
        var sAdj5; var adj5 = 75000 * slideFactor
        var cnstVal1 = 25000 * slideFactor
        var cnstVal2 = 100000 * slideFactor
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
        ...
        var th; var aw2; var th2; var dh2; var ah; var bw; var bs; var bd; var bd3; var bd2
        var th = minWH * a1 / cnstVal2
        aw2 = minWH * a2 / cnstVal2
        th2 = th / 2
        dh2 = aw2 - th2
      ...
      case 'stripedRightArrow':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var adj1 = 50000 * slideFactor
        var sAdj2; var adj2 = 50000 * slideFactor
        var cnstVal1 = 100000 * slideFactor
        ...
        var a1; var a2; var x4; var x5; var dx5; var x6; var dx6; var y1; var dy1; var y2; var maxAdj2; var vc = h / 2
        var minWH = Math.min(w, h)
      ...
      case 'notchedRightArrow':
        ...
        var a1; var a2; var x1; var x2; var dx2; var y1; var dy1; var y2; var maxAdj2; var vc = h / 2; var hd2 = vc
        var minWH = Math.min(w, h)
      ...
      case 'homePlate':
        ...
        var a; var x1; var dx1; var maxAdj; var vc = h / 2
        var minWH = Math.min(w, h)
      ...
      case 'chevron':
        ...
        var a; var x1; var dx1; var x2; var maxAdj; var vc = h / 2
        var minWH = Math.min(w, h)
        maxAdj = cnstVal1 * w / minWH
        if (adj < 0) a = 0
        else if (adj > maxAdj) a = maxAdj
      ...
      case 'rightArrowCallout':
        ...
        var sAdj2; var adj2 = 25000 * slideFactor
        var sAdj3; var adj3 = 25000 * slideFactor
        var sAdj4; var adj4 = 64977 * slideFactor
        var cnstVal1 = 50000 * slideFactor
        var cnstVal2 = 100000 * slideFactor
        var cnstVal3 = 200000 * slideFactor
        if (shapAdjst_ary !== undefined) {
        ...
        var vc = h / 2; var r = w; var b = h; var l = 0; var t = 0
        var ss = Math.min(w, h)
      ...
      case 'downArrowCallout':
        ...
        var hc = w / 2; var r = w; var b = h; var l = 0; var t = 0
        var ss = Math.min(w, h)
      ...
      case 'leftRightArrowCallout':
        ...
        var sAdj2; var adj2 = 25000 * slideFactor
        var sAdj3; var adj3 = 25000 * slideFactor
        var sAdj4; var adj4 = 48123 * slideFactor
        var cnstVal1 = 50000 * slideFactor
        var cnstVal2 = 100000 * slideFactor
        var cnstVal3 = 200000 * slideFactor
        if (shapAdjst_ary !== undefined) {
        ...
        var vc = h / 2; var hc = w / 2; var r = w; var b = h; var l = 0; var t = 0
        var ss = Math.min(w, h)
        maxAdj2 = cnstVal1 * h / ss
        a2 = (adj2 < 0) ? 0 : (adj2 > maxAdj2) ? maxAdj2 : adj2
        maxAdj1 = a2 * 2
      ...
      case 'quadArrowCallout':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var adj1 = 18515 * slideFactor
        var sAdj2; var adj2 = 18515 * slideFactor
        var sAdj3; var adj3 = 18515 * slideFactor
        var sAdj4; var adj4 = 48123 * slideFactor
        var cnstVal1 = 50000 * slideFactor
        var cnstVal2 = 100000 * slideFactor
        var cnstVal3 = 200000 * slideFactor
      ...
      case 'curvedDownArrow':
        ...
        var vc = h / 2; var hc = w / 2; var wd2 = w / 2; var r = w; var b = h; var l = 0; var t = 0; var c3d4 = 270; var cd2 = 180; var cd4 = 90
        var ss = Math.min(w, h)
      ...
      case 'curvedLeftArrow':
        ...
        var vc = h / 2; var hc = w / 2; var hd2 = h / 2; var r = w; var b = h; var l = 0; var t = 0; var c3d4 = 270; var cd2 = 180; var cd4 = 90
        var ss = Math.min(w, h)
      ...
      case 'mathPlus':
        ...
        var cnstVal3 = 200000 * slideFactor
        var dVal
        var hc = w / 2; var vc = h / 2; var hd2 = h / 2
        if (shapType == 'mathNotEqual') {
          ...
          var angVal1 = 70 * Math.PI / 180; const angVal2 = 110 * Math.PI / 180
      ...
      case 'swooshArrow':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var refr = slideFactor
        var sAdj1; var adj1 = 25000 * refr
        var sAdj2; var adj2 = 16667 * refr
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
            var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
            if (sAdj_name == 'adj1') {
      ...
      case 'circularArrow':
        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd'])
        var sAdj1; var adj1 = 12500 * slideFactor
        var sAdj2; var adj2 = (1142319 / 60000) * Math.PI / 180
        var sAdj3; var adj3 = (20457681 / 60000) * Math.PI / 180
        var sAdj4; var adj4 = (10800000 / 60000) * Math.PI / 180
        var sAdj5; var adj5 = 12500 * slideFactor
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
            var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name'])
            if (sAdj_name == 'adj1') {
        ...
        var vc = h / 2; var hc = w / 2; var r = w; var b = h; var l = 0; var t = 0; var wd2 = w / 2; var hd2 = h / 2
        var ss = Math.min(w, h)
      ...
      case 'leftCircularArrow':
        ...
        var sAdj1; var adj1 = 12500 * slideFactor
        var sAdj2; var adj2 = (-1142319 / 60000) * Math.PI / 180
        var sAdj3; var adj3 = (1142319 / 60000) * Math.PI / 180
        var sAdj4; var adj4 = (10800000 / 60000) * Math.PI / 180
        var sAdj5; var adj5 = 12500 * slideFactor
        if (shapAdjst_ary !== undefined) {
          for (var i = 0; i < shapAdjst_ary.length; i++) {
    ...
    const maxX = parseInt(attrs.w)// * slideFactor;
    const maxY = parseInt(attrs.h)// * slideFactor;
    const cX = (1 / maxX) * w
    const cY = (1 / maxY) * h
    // console.log("w = "+w+"\nh = "+h+"\nmaxX = "+maxX +"\nmaxY = " + maxY);
    ...
    if (moveToNode.length > 0) {
      ...
      if (Array.isArray(arcToNodes) && arcToNodes.length) {
        for (let index = 0; index < arcToNodes.length; index++) {
          const arcToNode = arcToNodes[index]
          const arcToNodesAttrs = arcToNode.attrs
          ...
          let shftX = 0
          let shftY = 0
          const arcToPtNode = getTextByPathList(arcToNode, ['a:pt', 'attrs'])
...
function shapeGear (w, h, points) {
  const innerRadius = h// gear.innerRadius;
  const outerRadius = 1.5 * innerRadius
  const cx = outerRadius// Math.max(innerRadius, outerRadius),                   // center x
  const cy = outerRadius// Math.max(innerRadius, outerRadius),                    // center y
  const notches = points; const // gear.points,                      // num. of notches
    radiusO = outerRadius // outer radius
  const radiusI = innerRadius // inner radius
...
async function processPicNode (node, warpObj, source, sType) {
  ...
  let vdoRid; let vdoFile; let vdoFileExt; let vdoMimeType; let uInt8Array; let blob; let vdoBlob; let mediaSupportFlag = false; let isVdeoLink = false
...
async function genTextBody (textBodyNode, spNode, slideLayoutSpNode, slideMasterSpNode, type, idx, warpObj, tbl_col_width) {
  ...
  for (let i = 0; i < apNode.length; i++) {
    ...
    // rtlStr = "";//"dir='"+isRTL+"'";
    let styleText = ''
    const marginsVer = getVerticalMargins(pNode, textBodyNode, type, idx, warpObj)
    if (marginsVer != '') {
    ...
    const sld_prg_width = ((prg_width_node !== undefined) ? ('width:' + (computedFactor(parseInt(prg_width_node))) + 'px;') : 'width:inherit;')
    const sld_prg_height = ((prg_height_node !== undefined) ? ('height:' + (computedFactor(parseInt(prg_height_node))) + 'px;') : '')
    ...
    text += "<div style='display: flex;" + sld_prg_width + sld_prg_height + "' class='slide-prgrph " + getHorizontalAlign(pNode, textBodyNode, idx, type, prg_dir, warpObj) + ' ' +
      prg_dir + ' ' + cssName + "' >"
    const buText_ary = await genBuChar(pNode, i, spNode, textBodyNode, pFontStyle, idx, type, warpObj)
    const isBullate = !!((buText_ary[0] !== undefined && buText_ary[0] !== null && buText_ary[0] != ''))
    const bu_width = (buText_ary[1] !== undefined && buText_ary[1] !== null && isBullate) ? buText_ary[1] + buText_ary[2] : 0
    text += (buText_ary[0] !== undefined) ? buText_ary[0] : ''
    // get text margin
    const margin_ary = getPregraphMargn(pNode, idx, type, isBullate, warpObj)
    ...
    const prg_width = ((prg_width_node !== undefined) ? ('width:' + (prg_width_node)) + 'px;' : 'width:inherit;')
...
async function genBuChar (node, i, spNode, textBodyNode, pFontStyle, idx, type, warpObj) {
  ...
  let bulvar = ''; let marRStr = ''; let marLStr = ''; let margin_val = 0; let font_val = 0
  /// //////////////////////////////////////////////////////////////
...
async function genSpanElement (node, rIndex, pNode, textBodyNode, pFontStyle, slideLayoutSpNode, idx, type, rNodeLength, warpObj, isBullate) {
  ...
  const openElemnt = '<sapn'// "<bdi";
  const closeElemnt = '</sapn>'// "</bdi>";
  let styleText = ''
  ...
  /// //////////////////////////////////////////////////////////////////////////////////
  // getFontColor
  const fontClrPr = await getFontColorPr(node, pNode, lstStyle, pFontStyle, lvl, idx, type, warpObj)
  ...
  const font_size = getFontSize(node, textBodyNode, pFontStyle, lvl, type, warpObj)
...
function getPregraphMargn (pNode, idx, type, isBullate, warpObj) {
  ...
  let marLStr = ''; let marRStr = ''; let maginVal = 0
  const pPrNode = pNode['a:pPr']
  const layoutMasterNode = getLayoutAndMasterNode(pNode, idx, type, warpObj)
  const pPrNodeLaout = layoutMasterNode.nodeLaout
  const pPrNodeMaster = layoutMasterNode.nodeMaster
...
async function getTableCellParams (tcNodes, getColsGrid, row_idx, col_idx, thisTblStyle, cellSource, warpObj) {
  ...
  let lin_left = ''
  let lin_right = ''
  let lin_bottom_left_to_top_right = ''
  let lin_top_left_to_bottom_right = ''
  ...
  const text = await genTextBody(tcNodes['a:txBody'], tcNodes, undefined, undefined, undefined, undefined, warpObj, total_col_width)// tableStyles
  ...
  if (lin_bottm === undefined && cellSource !== undefined) {
    if (cellSource !== undefined) { lin_bottm = getTextByPathList(thisTblStyle[cellSource], ['a:tcStyle', 'a:tcBdr', 'a:bottom', 'a:ln']) }
  ...
  if (lin_top === undefined) {
    if (cellSource !== undefined) { lin_top = getTextByPathList(thisTblStyle[cellSource], ['a:tcStyle', 'a:tcBdr', 'a:top', 'a:ln']) }
    if (lin_top === undefined) {
  ...
  if (lin_left === undefined) {
    if (cellSource !== undefined) { lin_left = getTextByPathList(thisTblStyle[cellSource], ['a:tcStyle', 'a:tcBdr', 'a:left', 'a:ln']) }
    if (lin_left === undefined) {
  ...
  if (lin_right === undefined) {
    if (cellSource !== undefined) { lin_right = getTextByPathList(thisTblStyle[cellSource], ['a:tcStyle', 'a:tcBdr', 'a:right', 'a:ln']) }
    if (lin_right === undefined) {
  ...
  if (celFillColor == '' || celFillColor == 'background-color: inherit;') {
    let bgFillschemeClr
    if (cellSource !== undefined) { bgFillschemeClr = getTextByPathList(thisTblStyle, [cellSource, 'a:tcStyle', 'a:fill', 'a:solidFill']) }
    if (bgFillschemeClr !== undefined) {
...
async function genDiagram (node, warpObj, source, sType) {
  ...
  const dgmClr = await readXmlFile(zip, dgmClrFileName)
  const dgmData = await readXmlFile(zip, dgmDataFileName)
  const dgmLayout = await readXmlFile(zip, dgmLayoutFileName)
  const dgmQuickStyle = await readXmlFile(zip, dgmQuickStyleFileName)
...
function getVerticalMargins (pNode, textBodyNode, type, idx, warpObj) {
  ...
  if (getTextByPathList(pNode, ['a:r']) !== undefined) {
    const fontSizeStr = getFontSize(pNode['a:r'], textBodyNode, undefined, lvl, type, warpObj)
  ...
  if (isInLayoutOrMaster && (spcBefNode === undefined || spcAftNode === undefined || lnSpcNode === undefined)) {
    // check in layout
    if (idx !== undefined) {
      const laypPrNode = getTextByPathList(warpObj, ['slideLayoutTables', 'idxTable', idx, 'p:txBody', 'a:p', (lvl - 1), 'a:pPr'])
  ...
  let spcBefor = 0; let spcAfter = 0; let spcLines = 0
...
async function getFontColorPr (node, pNode, lstStyle, pFontStyle, lvl, idx, type, warpObj) {
  ...
  let filTyp; let color; var textBordr; let colorType = ''; let highlightColor = ''
  ...
  //     color = "" + color;
  // }
  let text_effcts = ''; let txt_effects
  if (colorType == 'solid') {
...
function getFontSize (node, textBodyNode, pFontStyle, lvl, type, warpObj) {
  ...
  if (!isNaN(fontSize)) {
    const normAutofit = getTextByPathList(textBodyNode, ['a:bodyPr', 'a:normAutofit', 'attrs', 'fontScale'])
...
function getBorder (node, pNode, isSvgMode, bType, warpObj) {
  ...
  if (isSvgMode) {
    return { color: borderColor, width: borderWidth, type: borderType, strokeDasharray }
  } else {
    return cssText + ';'
  }
  // } else {
...
async function getBgPicFill (bgPr, sorce, warpObj, phClr, index) {
  ...
  let bgcolor
  const picFillBase64 = await getPicFill(sorce, bgPr['a:blipFill'], warpObj)
  ...
  if (tileNode !== undefined && tileNode.sx !== undefined) {
    ...
    const algn = tileNode.algn // tl(top left),t(top), tr(top right), l(left), ctr(center), r(right), bl(bottom left), b(bottm) , br(bottom right)
    const flip = tileNode.flip // none,x,y ,xy
...
async function getShapeFill (node, pNode, isSvgMode, warpObj, source) {
  ...
  if (fillColor !== undefined) {
    if (fillType == 'GRADIENT_FILL') {
      ...
      //     return fillColor;
      // } else {
      let bgPtrn = ''; let bgSize = ''; let bgPos = ''
      bgPtrn = fillColor[0]
...
function getPatternFill (node, warpObj) {
  ...
  let fgColor = ''; let bgColor = ''; let prst = ''
...
function SVGangle (deg, svgHeight, svgWidth) {
  ...
  const m = o + (n / i)
  var tx1 = tx1 == 2 ? i * (m - l) / (Math.pow(i, 2) + 1) : tx1
  var ty1 = ty1 == 2 ? i * tx1 + l : ty1
  var tx2 = tx2 == 2 ? w - tx1 : tx2
  var ty2 = ty2 == 2 ? h - ty1 : ty2
